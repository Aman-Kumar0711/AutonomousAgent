...
class WebsiteAudit(Base):
    ...
    has_online_payments: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    has_newsletter: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    has_online_ordering: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    has_whatsapp: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    has_crm: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    has_auto_reminders: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    has_review_widget: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
    has_maps_embed: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True)
